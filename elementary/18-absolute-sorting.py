...
#absolute value in ascending order. For example, the sequence (-20, -5, 10, 15)
#will be sorted like so: (-5, 10, 15, -20). Your function should return the
...
checkio = functools.partial( sorted , key = abs )
